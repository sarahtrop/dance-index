...
contra_dances = [
    ...
    {title: "Daddy's Little Girl", author: ['Chart Guthrie'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N allemande R 1 3/4 \n (8) G allemande L 1 1/2", a_2: "(16) P balance and swing", b_1: "(8) L chain \n (8) R&L through", b_2: "(8) Circle L \n (8) L star"},
    {title: "Cal and Irene", author: ['Dan Pearl'], formation: ['Improper'], progression: ['Double'], a_1: "(16) N Balance and swing", a_2: "(8) with N, slide L and cirlce 3/4 \n (8) Balance ring, N cali twirl", b_1: "(4) Balance ring \n (12) P swing", b_2: "(8) Promenade across set \n (8) Circle L 3/4, pass through"},
    {title: "Ben's Brilliance", author: ['Tony Parkes'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N dosido \n (8) N swing (end facing up/down) with ladies in center", a_2: "(6) promenade along line \n (4) Turn as a couple (gents in center) \n (6) come back", b_1: "(8) G allemande L 1 1/2 \n (8) P swing", b_2: "(8) R&L through \n (8) L chain"},
    {title: "La Habanera", author: ['Mike Richardson'], formation: ['Improper'], progression: ['Double'], a_1: "(8) Circle L once \n (8) N dosido 1 1/4 to wave of 4, L in center", a_2: "(4) Balance wave forward and back \n (4) Balance again forward and back \n (8) L allemande 1 1/2 while G orbit CW once", b_1: "(16) P balance and swing", b_2: "(8) LL forward and back \n (8) L allemande R 1 1/2 to progress"},
    {title: "DuQuoin Races", author: ['Orace Johnson'], formation: ['Improper'], progression: ['Double'], a_1: "(8) Balance ring, pass the ocean \n (8) Balance, allemande P R 3/4 to long waves", a_2: "(8) Balance, circulate \n (8) Balance, circulate", b_1: "(8) P swing \n (8) Circle L 1/2, N rollaway across", b_2: "(8) Circle L 1/2, P rollaway on side \n (8) Circle L 1/2, slide L to new"},
    {title: "California Contra", author: ['Tony Parkes'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N dosido \n (8) N swing", a_2: "(8) LL forward and back \n (8) L chain", b_1: "(4) Shadow allemande L \n (12) P swing", b_2: "(12) Circle L 1 1/4 \n (4) P california twirl"},
    {title: "Purple Heys", author: ['Mike Richardson'], formation: ['Improper'], progression: ['Double'], a_1: "(16) 1s balance and swing", a_2: "(16) N balance and swing", b_1: "(16) R diagonal hey, 1s allemande R 1/2 to start (pass same-role by L to start)", b_2: "(16) L diagonal hey, 1s allemande R 1/2 to start (pass opposite role by R)"},
    {title: "Fiddler's Fling", author: ['Cary Ravitz'], formation: ['Improper'], progression: ['Double'], a_1: "(16) N balance and swing", a_2: "(8) G lead mad robin \n (8) L pull to 1/2 pousette", b_1: "(8) G take L, L take R to gypsy star 3/4 (L forward, G back) \n (8) P swing", b_2: "(8) R&L through \n (8) L chain"},
    {title: "Wedding Rings", author: ['Evan Shepherd'], formation: ['Improper'], progression: ['Double'], a_1: "(8) Circle L \n (8) Star R hands across", a_2: "(4) Men drop, L allemande R \n (12) P swing", b_1: "(8) LL forward and back \n (8) L chain", b_2: "(8) Balance N, star through \n (8) Circle L 3/4 and slide L to new"},
    {title: "Julie's Reel", author: ['Penn Fix'], formation: ['Improper'], progression: ['Double'], a_1: "(4) N take inside hands \n (4) Star through \n (8) L chain", a_2: "(4) Pass through across and cross trail on side \n (12) Pass first neighbor by R, allemande next by L once, return passing first neightbor by R", b_1: "(16) P swing", b_2: "(8) R&L through \n (8) L dosido 1 1/2"},
    {title: "Becket Eyes", author: ['Cary Ravitz'], formation: ['Becket'], progression: ['Double'], a_1: "(8) LL forward and back \n (8) L chain", a_2: "(8) Star L once \n (8) Look away for new neighbor, and swing", b_1: "(8)  1/2 hey G pasing L to start \n (8) G allemande L 1 1/2", b_2: "(16) P gypsy and swing"},
    {title: "Another Wavy Line", author: ['Bob Dalsemer'], formation: ['Improper'], progression: ['Double'], a_1: "(8) Dosido N 1 1/4 to wavy line with L in center \n (8) Balance wave, allemande R N 1/2 to wave with G in center", a_2: "(8) Balance wave, G allemande L once \n (8) N swing", b_1: "(8) Circle L 3/4 \n (8) P swing", b_2: "(8) LL forward and back \n (8) L allemande L 1/2 to new"},
    {title: "Tuesday Child", author: ['Brian Jones'], formation: ['Improper'], progression: ['Double'], a_1: "(8) 1s 1/2 figure 8 down \n (8) R&L through", a_2: "(16) L chain over and back", b_1: "(16) Down thehall in line of 4, 1s in middle - turn alone and come back", b_2: "(8) Circle L once \n (8) 2s 1/2 figure 8 down"},
    {title: "Centrifugal Hey", author: ['Gene Hubert'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N allemande R 1 1/2 \n (8) G allemande L 1 1/2", a_2: "(16) P pass R to full hey", b_1: "(16) P balance and swing", b_2: "(8) R&L through \n (8) Circle L 3/4, pass through"},
    {title: "Delphiniums and Daisies", author: ['Tanya Rotenburg'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N allemande L 1 1/2 \n (8) L chain", a_2: "(16) L pass R to full hey", b_1: "(16) P balance and swing", b_2: "(8) Circle L 3/4 \n (8) N allemande R 1 1/2"},
    {title: "Cranky Ingenuity", author: ['Bill Olsen'], formation: ['Improper'], progression: ['Double'], a_1: "(8) Circle L once \n (8) As a couple, dosido", a_2: "(8) N dosido \n (8) N swing", b_1: "(8) G allemande L 1 1/2 \n (8) P swing", b_2: "(8) Circle L 3/4 \n (8) Balance and cali twirl"},
    {title: "Trip to Lambertville", author: ['Steve Zaiken-Anderson'], formation: ['Improper'], progression: ['Double'], a_1: "(8) L walk to center, balance wavy line \n (8) L backup, G to center, balance wavy line", a_2: "(8) G allemande L 3/4, R to N in short wave and balance \n (8) N swing", b_1: "(8) G allemande L 1/2 \n (8) P swing", b_2: "(8) Promenade across \n (8) L chain"},
    {title: "Summer Sunshine", author: ['Paul Balliet'], formation: ['Improper'], progression: ['Double'], a_1: "(4) Balance wave of 4, women take L in center \n (12) N swing", a_2: "(16) L chain over and back", b_1: "(8) Circle L 3/4 \n (8) P swing", b_2: "(8) Circle L 3/4 to wave of 4 \n (8) Balance, walk to new wave"},
    {title: "Presto Petronella", author: ['Cary Ravitz'], formation: ['Becket'], progression: ['Double'], a_1: "(8) R&L through \n (8) L diagonal L chain", a_2: "(8) Circle L 3/4 and pass through up/down \n (8) P gypsy 1 1/2", b_1: "(8) Balance ring, petronella \n (8) Balance ring, petronella", b_2: "(16) P balance and swing"},
    {title: "Wave Action #1", author: ['Mike Richardson'], formation: ['Becket'], progression: ['Double'], a_1: "(8) LL forward and back \n (4) Pass through to ocean wave \n (4) Balance wave", a_2: "(4) L allemande L 1/2 to new wave \n (4) Balance wave \n (4) Walk forward to new wave \n (4) Balance wave", b_1: "(4) N allemande R 3/4 \n (12) L pass L to start hey 3/4", b_2: "(16) P swing"},
    {title: "Chinese New Year", author: ['Chris Page'], formation: ['Improper'], progression: ['Double'], a_1: "Start in long waves, G face out and L face in \n (8) Balance wave and circulate \n (8) Balance wave and circulate", a_2: "(8) Balance and circulate \n (8) P swing", b_1: "(8) Cricle L 3/4 \n (8) N swing", b_2: "(8) LL forward and back \n (8) Square through to new waves"},
    {title: "Treasure of the Sierra Madre", author: ['James Hutson'], formation: ['Improper'], progression: ['Double'], a_1: "(4) N balance R \n (4) N box gnat \n (8) G allemande L 1 1/2", a_2: "(4) P balance R \n (4) P box gnat \n (2) P pull by R (6) G lead 1/2 hey by L", b_1: "(16) P balance and swing", b_2: "(8) L chain \n (8) Star L to next (once)"},
    {title: "The Carosel", author: ['Tom Hinds'], formation: ['Improper'], progression: ['Double'], a_1: "(8) LL forward and back \n (8) L allemande L 1 1/2", a_2: "(16) P pass by R for hey", b_1: "(16) P balance and swing", b_2: "(8) Circle L 3/4 \n (8) N swing"},
    {title: "Hey in Barn", author: ['Chart Guthrie'], formation: ['Improper'], progression: ['Double'], a_1: "(16) N balance and swing", a_2: "(8) L chain \n (8) L pass R to 1/2 hey", b_1: "(16) P balance and swing", b_2: "(8) L chain \n (8) L pass R to 1/2 hey"},
    {title: "Mad Robin in Love", author: ['Greg Frock'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N gypsy \n (8) N swing", a_2: "(8) LL forward and back \n (8) Mad robin G in front", b_1: "(4) G pass R \n (12) P swing", b_2: "(8) Circle L 3/4 \n (4) Ring balance \n (4) P cali twirl"},
    {title: "Another Nice Combination", author: ['Tom Hinds'], formation: ['Improper'], progression: ['Double'], a_1: "(16) N balance and swing", a_2: "(8) Circle L 3/4, face P and pass through \n (8) Dosido shadow", b_1: "(16) P balance and swing", b_2: "(8) L chain \n (8) Star L"},
    {title: "Gypsy Everyone", author: ['Seth Tepfer'], formation: ['Improper'], progression: ['Double'], a_1: "(8) N dosido \n (8) L left shoulder gypsy", a_2: "(8) N gypsy \n (8) N swing", b_1: "(8) G gypsy 1 1/2 \n (8) P swing", b_2: "(8) LL forward and back \n (8) L chain"},
]
